(() => {
  ...
  const themes = {
    ...
    trustworthy: {number:'T / Trustworthy AI systems',title:'Building safe and secure agents.',description:'How can we build AI systems that remain safe, secure, and auditable as they learn and act? I study defenses, auditing, and evaluation across complete interactions, including how agents use tools and respond to untrusted inputs.',topics:['Prompt-injection defense and adversarial robustness','Safe tool use, privacy, and policy compliance','Trajectory auditing, reliable evaluation, and human control'],connection:'Trustworthiness is a design goal across learning, memory, decisions, and tools: agents should preserve safety, resist attacks, and recognize and recover from failure.'}
  };
